document.addEventListener('DOMContentLoaded', function () {
  ...
  const projects = [
    ...
    },
    {
      id: "project4",
      title: "Agile Air",
      description: "A flight tracking and booking platform with real-time updates and interactive maps.",
    ...
    },
    {
      ...
      image: "https://www.google.com/url?sa=i&url=https%3A%2F%2Fdribbble.com%2Fshots%2F9656988-Water-Monitoring-System&psig=AOvVaw0X1tAlbUMo0Nwvm7q2DrYo&ust=1741493593183000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCIDuirHP-YsDFQAAAAAdAAAAABAE",
      technologies: ["Arduino", "IoT", "React", "Python", "Data Visualization"]
    }
  ];
  ...
  function showProjectModal(project) {
      ...
      modalDescription.textContent = project.detailedDescription || project.description;
